					...
					var tabItem_1 = (function(tabFolder){
						...
						(function(container){
							...
							(function(container){
								...
								formLayout_2.setRows(["110px", "110px", "110px", "30px", "30px", "30px", "30px", "115px"]);
								...
								(function(container){
									...
									formLayout_3.setRows(["30px", "25px"]);
									...
									formLayout_4.setColumns(["180px", "100px"]);
									formLayout_4.setRows(["26px", "30px", "30px"]);
									...
									(function(container){
										...
										if(typeof onIpbEmailKeyup == "function") {
											inputBox_5.addEventListener("keyup", onIpbEmailKeyup);
										}
									...
									(function(container){
										...
										if(typeof onIpbPassword1Keyup == "function") {
											inputBox_6.addEventListener("keyup", onIpbPassword1Keyup);
										}
									...
									(function(container){
										...
										if(typeof onIpbPassword2Keyup == "function") {
											inputBox_7.addEventListener("keyup", onIpbPassword2Keyup);
										}
										if(typeof onIpbPassword2ValueChange == "function") {
											inputBox_7.addEventListener("value-change", onIpbPassword2ValueChange);
										}
										if(typeof onIpbPassword2Keydown == "function") {
											inputBox_7.addEventListener("keydown", onIpbPassword2Keydown);
										}
										if(typeof onIpbPassword2Input == "function") {
											inputBox_7.addEventListener("input", onIpbPassword2Input);
										}
										...
										var output_15 = new cpr.controls.Output("opbCheckPassword2");
										output_15.value = "";
