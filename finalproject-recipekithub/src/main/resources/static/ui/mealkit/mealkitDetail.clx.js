	...
	var app = new cpr.core.App("mealkit/mealkitDetail", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			(function(container){
				...
				(function(container){
					var output_2 = new cpr.controls.Output("price");
					output_2.bind("value").toDataMap(app.lookup("mealkit"), "mealkitPrice");
				...
				(function(container){
					...
					var output_4 = new cpr.controls.Output("inventory");
					output_4.bind("value").toDataMap(app.lookup("mealkit"), "mealkitInventory");
				...
				(function(container){
					...
					output_7.value = " 다음날 우리집 식탁까지 배송되어요.";
					output_7.style.css({
						"font-size" : "12px"
					});
				...
				(function(container){
					...
					var output_8 = new cpr.controls.Output("mealcnt");
					output_8.value = "1";
					output_8.style.css({
						"text-align" : "center"
					});
					...
					var output_9 = new cpr.controls.Output("name2");
					output_9.bind("value").toDataMap(app.lookup("mealkit"), "mealkitName");
					...
					output_10.bind("value").toDataMap(app.lookup("mealkit"), "total");
				...
				(function(container){
					var output_11 = new cpr.controls.Output("info");
					output_11.bind("value").toDataMap(app.lookup("mealkit"), "mealkitInfo");
				...
				var output_12 = new cpr.controls.Output("ingredients");
				output_12.bind("value").toDataMap(app.lookup("mealkit"), "mealkitIngredients");
