/*
 * App URI: dialog/Dialog
 * Source Location: dialog/Dialog.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("dialog/Dialog", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			function onBodyLoad(/* cpr.events.CEvent */ e){
				var vcDialog = app.getHost(); // 해당 앱이 누군가로부터 불렸는지 (부모가 있는지) 확인

				if (vcDialog){
					var voInitValue = app.getHostProperty("initValue"); // 다이얼로그의 initValue 가져오기
					if (!ValueUtil.isNull(voInitValue)){
						app.lookup("optValue").value = voInitValue["msg"]; // initValue 내의 msg 값을 아웃풋에 표시
					}
				}
			}
